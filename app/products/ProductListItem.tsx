...
export default function ProductListItem({ product }: ProductListItemProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-100">
      <div className={`flex ${isRTL ? "flex-row-reverse" : ""} gap-6 p-6`}>
        {/* Product Image */}
        ...
        <div className="flex-1 min-w-0">
          ...
          {averageRating > 0 && (
            ...
            >
              ...
              <span
                className={`text-sm text-gray-500 ${isRTL ? "mr-2" : "ml-2"}`}
              >
          ...
          <div className="flex items-center gap-3">
            {isInStock ? (
              isInCart ? (
                <div className="flex items-center bg-purple-50 rounded-lg p-2 gap-3">
                  <Button
                    size="sm"
                    variant="outline"
                  ...
                  <span className="text-sm font-semibold text-purple-700 min-w-[2rem] text-center">
                    {cartQuantity}
                  </span>
                  <Button
                    size="sm"
