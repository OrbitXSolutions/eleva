 ...
 */
export function logImageError(src: string, error: string | Event, context?: string) {
...
export function getNextFallback(
  ...
  if (currentSrc !== primary && currentSrc !== secondary && currentSrc !== final) {
 ...
 */
export function preloadImageWithError(src: string): Promise<{ success: boolean; error?: string }> {
